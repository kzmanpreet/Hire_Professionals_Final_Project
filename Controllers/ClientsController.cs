...
namespace Hire_Professionals_Final_Project.Controllers
{
    ...
    //Client information controller only accessible by the admin
    [Authorize(Roles ="data_admin")]
    public class ClientsController : Controller
    {
        private readonly Hire_ProfessionalsDatatContext _context;

        public ClientsController(Hire_ProfessionalsDatatContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Mobile,Email")] Client client)
        {
            if (id != client.Id)
            {
                return NotFound();
